...
export default function Home() {
  ...
  useEffect(() => {
    ...
    initImage.onload = () => setTimeout(() => smallImg.style.opacity = 1);
    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <Post config={{
          ...
          copy: "I was hired to create a web application that allowed clients like the Utah Jazz custom design and order t-shirts. Check out the sandbox to explore my app!",
